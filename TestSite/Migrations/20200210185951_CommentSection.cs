    ...
    public partial class CommentSection : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainCommnets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MainCommnets_Posts_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubComments_MainCommnets_MainCommentId",
                        column: x => x.MainCommentId,
                        principalTable: "MainCommnets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_MainCommnets_PostId",
                table: "MainCommnets",
                column: "PostId");
